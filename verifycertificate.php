...
<head>
    ...
    <title>CMS | Certificate Verification</title>
...
<nav class="navbar navbar-expand-lg navbar-light">    
    <div class="container-fluid">
        <a class="navbar-brand" style="font-size:22px;text-align:center;" href="#"><img src="assets/img/logo.png" height="46px" width="50px" alt="Logo not found" style="margin-left: 30px;">&nbsp Certificate Management System</a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <ul class="navbar-nav mr-auto ml-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"style="font-size:20px;" href="./index.php#aboutus">About Us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"style="font-size:20px;" href="./index.php#services">Services</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="font-size:20px;" href="./index.php#contactus">Contact Us</a>
                    </li>
                </ul>    
            </div>
        </div>
...
if(isset($_REQUEST['view_details'])){
	...
	$no=$_REQUEST['certificate_number'];
        ...
        $row = mysqli_fetch_assoc($result); 
            ...
            $secret =md5('$certificate_number');

            $message = "Certificate is valid and was issued on $issued_date";
    ...
    <div class="row" style="margin:30px 0;">
        ...
        <div class="col-md-3 col-sm-12">  
            <div class="certificate_download">
                <form target="_blank" action="./admin/<?php echo $location?>?certificatedownload=<?php echo $secret?>" method="POST">
