...
<head>
    ...
    <title>CMS | New Certificate Request</title>
                ...
                <form action="./dashboard.php" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
                            <input type="text" name="name" class="form-control" id="inputName" placeholder="Name on Certificate" required >
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
                            <input type="email"  name="email" class="form-control" id="inputEmail" placeholder="User Email" required>
                        </div>
                    </div>
